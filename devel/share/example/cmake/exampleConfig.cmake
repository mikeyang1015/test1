...
if("TRUE" STREQUAL "TRUE")
  set(example_SOURCE_PREFIX /home/mike/test1/src/example)
  set(example_DEVEL_PREFIX /home/mike/test1/devel)
  set(example_INSTALL_PREFIX "")
  set(example_PREFIX ${example_DEVEL_PREFIX})
else()
  set(example_SOURCE_PREFIX "")
  set(example_DEVEL_PREFIX "")
  set(example_INSTALL_PREFIX /home/mike/test1/install)
...
if(NOT "/home/mike/test1/devel/include " STREQUAL " ")
  set(example_INCLUDE_DIRS "")
  set(_include_dirs "/home/mike/test1/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'example' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mike/test1/src/example/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT example_NUM_DUMMY_TARGETS)
      set(example_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::example::wrapped-linker-option${example_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR example_NUM_DUMMY_TARGETS "${example_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::example::wrapped-linker-option${example_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND example_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mike/test1/devel/lib;/opt/ros/melodic/lib)
